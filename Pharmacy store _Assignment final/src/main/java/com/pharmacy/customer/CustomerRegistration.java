...
public class CustomerRegistration {
    ...
    try {
      ...
      PreparedStatement statement = connection.prepareStatement("INSERT INTO customer(User_Id, Password, Email_Id, Age, Contact, City, State, Pincode, Role_Id)" + "VALUES (?,?,?,?,?,?,?,?,?)");
      statement.setString(1,demo.getUser_id());
      statement.setString(2,demo.getPassword());
      statement.setString(3,demo.getEmail_id());
      statement.setString(4,demo.getAge());
      ...
      statement.setString(9,demo.getRole_id());
